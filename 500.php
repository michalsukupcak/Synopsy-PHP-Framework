    ...
    <body>
        <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <div class="container">
                            <h3>
                                <i>
                                    Ooops ... Something just wen't very, very wrong on our server.
                                </i>
                            </h3>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        We deeply apologize to you for this problem and any inconvenience this might have caused.
                        <br>
                        Our administrators have been notified and are currently doing their best to fix this issue as fast as possbile.
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <img src="<?=URL?>resources/plugins/error/polarbear.jpg" id="puppy">
                    </div>
                </div>
            </div>
            <br>
