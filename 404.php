    ...
    <body>
        <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <div class="container">
                            <h3>
                                <i>
                                    Aaaw snap ... The page you're trying to access doesn't exist.
                                </i>
                            </h3>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        We know this is a frustrating experience for each user,
                        however there's not much we can do about this.
                        <br>
                        Anyway, here's a picture of a cute puppy to brighten up 
                        your day a little.
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <img src="<?=URL?>resources/plugins/error/puppy-<?=mt_rand(1,7)?>.gif" id="puppy">
                    </div>
                </div>
            </div>
            <br>
